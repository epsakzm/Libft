...
NAME			= libft.a
SRCS			=	ft_atoi.c ft_strlen.c ft_calloc.c ft_isprint.c \
					...
					ft_putendl_fd.c ft_strchr.c ft_strdup.c ft_strlcat.c \
					ft_strlcpy.c ft_strncmp.c ft_strnstr.c ft_bzero.c \
					ft_strrchr.c ft_substr.c ft_tolower.c ft_toupper.c \
					ft_itoa.c ft_split.c ft_strjoin.c ft_strmapi.c \
					ft_strtrim.c ft_putnbr_fd.c
OBJS			= $(SRCS:.c=.o)
